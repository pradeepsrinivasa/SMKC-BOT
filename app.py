...
# Telegram Bot Token
TELEGRAM_TOKEN = "AAGaAPcePH2xSZWAi2aZjc8C8dWm3fqDfq8"

# Handler function for handling Telegram /start command
def start(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Hello! I'm SMKC bot.")

# Handler function for handling Telegram messages
...
def telegram_webhook():
    ...
    # Process updates
    update.process_update(request.json)
    return 'ok'
...
conn=mysql.connector.connect(host='localhost',port='3306',user='root',password='PRADEEP2003@p',database='register', auth_plugin='mysql_native_password')
cur=conn.cursor()
